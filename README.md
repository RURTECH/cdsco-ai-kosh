...
4. For the **Space SDK**, select **Docker** (Blank).
5. Click **Create Space**.
6. Once created, link it to your GitHub repository or simply upload the files from this folder directly into the Space.
