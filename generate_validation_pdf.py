...
def generate_pdf():
    doc = SimpleDocTemplate("RurTech_Validation_Accuracy_Proof.pdf", pagesize=A4,
    ...
    with open("RurTech_Validation_Accuracy_Proof.md", "r", encoding="utf-8") as f:
        lines = f.readlines()
    ...
    for line in lines:
        ...
        if line.startswith("# "):
            ...
            # Inject Accuracy Image under Section 4
            if "4." in line and os.path.exists("accuracy.png"):
                elements.append(Spacer(1, 10))
    ...
    doc.build(elements)
    print("Validation PDF Generated successfully!")
